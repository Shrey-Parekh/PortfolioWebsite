  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          background: isHovered 
            ? `radial-gradient(circle at ${50 + mousePosition.x * 25}% ${50 + mousePosition.y * 25}%, rgba(0, 122, 255, 0.18) 0%, rgba(88, 86, 214, 0.12) 25%, rgba(175, 82, 222, 0.08) 50%, rgba(255, 45, 146, 0.04) 75%, transparent 90%)`
      ...
      <motion.div
        ...
        animate={{
          background: isHovered 
            ? `conic-gradient(from ${mousePosition.x * 180}deg at ${50 + mousePosition.x * 15}% ${50 + mousePosition.y * 15}%, rgba(0, 122, 255, 0.05) 0deg, rgba(88, 86, 214, 0.03) 120deg, rgba(175, 82, 222, 0.02) 240deg, rgba(0, 122, 255, 0.05) 360deg)`
          ...
          <defs>
            <pattern id="grid" width="8" height="8" patternUnits="userSpaceOnUse">
              <motion.path 
                ...
                animate={{
                  ...
                  stroke: isHovered ? "rgba(0, 122, 255, 0.2)" : "rgba(0, 122, 255, 0.15)"
                }}
            ...
            <pattern id="dots" width="20" height="20" patternUnits="userSpaceOnUse">
              <motion.circle 
                ...
                animate={{
                  r: isHovered ? "0.8" : "0.5",
                  fill: isHovered ? "rgba(88, 86, 214, 0.15)" : "rgba(88, 86, 214, 0.1)"
                }}
                transition={{ duration: 0.6 }}
              />
            </pattern>
      ...
      <div className="absolute inset-0">
        ...
        {[...Array(6)].map((_, i) => {
          ...
          return (
            <motion.div
              ...
              animate={{
                x: Math.cos(angle + mousePosition.x * 0.5) * radius + mousePosition.x * 25 - 20,
                y: Math.sin(angle + mousePosition.y * 0.5) * radius + mousePosition.y * 25 - 20,
        ...
        {[
          { position: 'top-8 left-8', delay: 0, color: 'rgba(0, 122, 255, 0.12)' },
          { position: 'top-8 right-8', delay: 0.15, color: 'rgba(88, 86, 214, 0.12)' },
          { position: 'bottom-8 left-8', delay: 0.3, color: 'rgba(175, 82, 222, 0.12)' },
          { position: 'bottom-8 right-8', delay: 0.45, color: 'rgba(255, 45, 146, 0.12)' }
        ].map((item, i) => (
          <motion.div
            key={i}
      ...
      <div className="absolute inset-0 pointer-events-none">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          <motion.path
            ...
            animate={{
              d: isHovered 
                ? `M0,50 Q25,${30 + mousePosition.y * 12} 50,${50 + mousePosition.x * 6} T100,50`
          ...
          <motion.path
            ...
            animate={{
              d: isHovered 
                ? `M50,0 Q${30 + mousePosition.x * 12},25 ${50 + mousePosition.y * 6},50 T50,100`
          ...
          <motion.path
            ...
            animate={{
              d: isHovered 
                ? `M0,0 Q${50 + mousePosition.x * 8},${25 + mousePosition.y * 8} 100,100`
                : "M0,0 Q50,25 100,100",
              opacity: isHovered ? 1 : 0.6
            }}
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
          ...
          <motion.path
            ...
            animate={{
              d: isHovered 
                ? `M100,0 Q${50 - mousePosition.x * 8},${75 - mousePosition.y * 8} 0,100`
                : "M100,0 Q50,75 0,100",
              opacity: isHovered ? 1 : 0.6
            }}
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle at ${50 + mousePosition.x * 35}% ${50 + mousePosition.y * 35}%, rgba(0, 122, 255, 0.08) 0%, rgba(88, 86, 214, 0.04) 30%, transparent 60%)`
        }}
        animate={{
          opacity: isHovered ? 1 : 0.8
        }}
      ...
      <motion.div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(ellipse at ${50 - mousePosition.x * 20}% ${50 - mousePosition.y * 20}%, rgba(175, 82, 222, 0.04) 0%, transparent 40%)`
        }}
        animate={{
      ...
      {isHovered && [...Array(8)].map((_, i) => (
        <motion.div
          ...
          style={{
            background: `rgba(${i % 2 === 0 ? '0, 122, 255' : '88, 86, 214'}, 0.6)`,
            left: `${20 + (i * 10)}%`,
            top: `${30 + (i * 5)}%`,
            boxShadow: `0 0 8px rgba(${i % 2 === 0 ? '0, 122, 255' : '88, 86, 214'}, 0.8)`
          }}
          animate={{
            y: [0, -20, 0],
            x: [0, Math.sin(i) * 15, 0],
